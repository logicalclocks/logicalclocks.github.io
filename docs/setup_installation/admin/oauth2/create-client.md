...
top right corner of the navigation bar and choosing _Cluster Settings_ from the dropdown menu. In the _Cluster
Settings_ _Configuration_ tab search for _oauth\_group\_mapping_ and click on the edit button.
