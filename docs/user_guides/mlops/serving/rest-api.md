...
Refer to the official [vLLM OpenAI-compatible server documentation](https://docs.vllm.ai/en/v0.20.0/serving/openai_compatible_server.html) for details about the available APIs.
...
For generative inference (vLLM), the request follows the [OpenAI specification](https://docs.vllm.ai/en/v0.20.0/serving/openai_compatible_server.html) supported by the vLLM OpenAI-compatible server.
