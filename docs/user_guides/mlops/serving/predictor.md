...
You can find all configuration parameters supported by the vLLM server in the [vLLM documentation](https://docs.vllm.ai/en/v0.20.0/cli/serve.html).
...
!!! info "Supported model servers"
    ...
    | vLLM                 | vLLM openai-compatible server                 | vLLM-supported models (see [list](https://docs.vllm.ai/en/v0.20.0/models/supported_models.html)) |
