...
If you or your Hopsworks administrator followed the [AWS Credentials Passthrough Guide](../../../../admin/roleChaining.md) you should be able to choose "Temporary Credentials" and see the roles, that your user is able to assume. Choose the role that gives you access to the specified bucket.
