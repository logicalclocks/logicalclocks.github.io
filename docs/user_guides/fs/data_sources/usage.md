...
Data Sources provide an important first step for integrating with external data sources.
...
The exact behaviour could change depending on the data source type, but broadly they could be classified as below
