...
Each increment is keyed by its batch start time, making the dataset time-addressable: reads can select a time range of increments instead of the whole dataset.
